...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0xa2F279Ad1C3d114028b3a8e9aD1Cb6802118E32f")
  const token = useToken("0x80711e2d72457f28EC5C01ff07E59b9FF782B177")
  const vote = useVote("0x6d842BBd6398edaAd0E50E7495256ac00c91C016")
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à BrejaDAO a DAO dos cervejeiros artesanais!</h1>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro da BrejaDAO 🍺</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
